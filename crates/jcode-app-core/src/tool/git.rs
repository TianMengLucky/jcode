...
impl Tool for GitCommitTool {
    ...
    fn description(&self) -> &str {
        "Create a commit from structured fields; the tool assembles the message."
    }
    ...
    fn parameters_schema(&self) -> Value {
        json!({
            ...
            "properties": {
                ...
                "repoPath": {
                    "type": "string",
                    "description": "Repo base dir; `paths` resolve relative to it; defaults to session dir."
                },
                "allowDefaultBranch": {
                    "type": "boolean",
                    "default": false,
                ...
                "signoff": {
                    "type": "boolean",
                    "default": true,
                    "description": "Append the configured co-author trailer; unset only to omit it."
                }
            }
        })
    }
...
impl Tool for GitCheckpointTool {
    ...
    fn description(&self) -> &str {
        "Snapshot index+worktree into a recoverable stash; promote via git_commit."
    }
