...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            reasoning_hidden_block: String::new(),
            reasoning_close_duration_secs: None,
            ...
            remote_model_display_name: None,
            remote_model_context_window: None,
            remote_available_efforts: None,
            ...
            inline_ask_user_question_state: None,
            pending_ask_user_question_response: None,
            ...
            dir_browser_overlay: None,
            pending_dir_browser_load: None,
            pending_remote_dir_browse: None,
            remote_dir_browse_inflight: None,
